# This classifies the same digit as the logistic regression classifiers from the first step. But here we're using
# a pre-trained neural network classifier (loaded from data/ex3weights.mat)
import numpy as np
...
# Numpy is 0 base index. We add +1 to make it compatible with matlab (so we can compare y_pred with the correct
# answers from Y_data).
